...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>D&D Scheduler - Home</title>
        <meta name="description" content="Welcome to the D&D Scheduler. Organize your campaigns, schedule sessions, and manage your characters all in one place." />
      </Helmet>
      <div className="flex-grow flex flex-col items-center justify-center text-center p-4">
        ...
        >
          Organize your campaigns, schedule sessions, and manage your characters all in one place. Your next legendary adventure starts here.
        </motion.p>
